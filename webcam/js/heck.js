...
function startTimers() {
   var screen1 = setTimeout(function(){
      ...
      document.getElementById('section2').style.display = 'block';}, 10000);

   var screen2 = setTimeout(function () {
      console.log('screen2 change works');
      document.getElementById('section2').style.display = 'none';
      document.getElementById('section3').style.display = 'block';}, 20000);

   var screen3 = setTimeout(function section_change3(screen3) {
      console.log('screen3 change works');
      document.getElementById('section3').style.display = 'none';
      document.getElementById('section4').style.display = 'block';}, 30000);

   var screen4 = setTimeout(function section_change4(screen4) {
